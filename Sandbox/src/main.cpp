...
public:
		...
		: Vulture::Application(appInfo, width, height)
	{
		...
		{
			Vulture::Entity& entity = m_Scene.CreateSprite({ { 0.5f, 0.0f, 0.0f }, glm::vec3(0.0f), glm::vec3(0.5f) }, "assets/Texture.png");
		}
		{
			Vulture::Entity& entity = m_Scene.CreateSprite({ { -0.5f, 0.0f, 0.0f }, glm::vec3(0.0f, 0.0f, 45.0f), glm::vec3(0.5f) }, "assets/Texture1.png");
		}
	}
